...
#ifndef CONFIG_TRAINING_DURATION_CONFIG_
#define CONFIG_TRAINING_DURATION_CONFIG_
...
using Duration = config::training::DurationConfigPtr;

}  // namespace training
}  // namespace option
}  // namespace config

#endif  // CONFIG_TRAINING_DURATION_CONFIG_
