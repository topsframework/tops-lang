...
void FilePrinter::print(unsigned int num) {
  *os_ << num;
}
...
void FilePrinter::printTag(const std::string &tag, std::size_t count,
                                                   std::size_t max) {
...
void FilePrinter::indent(unsigned int extra_depth) {
